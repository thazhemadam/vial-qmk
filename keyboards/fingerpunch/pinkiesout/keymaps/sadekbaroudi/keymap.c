...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MOUSE] = LAYOUT_wrapper(
        ...
        _______,                   __________________MOUSE_1__________________,                   _______,                 TO(_WINNAV),               ___________________BLANK___________________,                   _______,
    ...
    [_WINNAV] = LAYOUT_wrapper(
        _______,       _______,       _______,       _______,       _______,       _______,       _______,                 TO(_MOUSE),    _______,       _______,       _______,       _______,       _______,       _______,
        _______,                   __________________WIN_NAV_1________________,                   _______,                 TO(_GAME),                 ___________________BLANK___________________,                   _______,
    ...
    [_GAME] = LAYOUT_wrapper(
        __GAMES_R0_L__,     ___________________GAMES_0_________________,     __GAMES_R0_R__,                               TO(_WINNAV),   _______,       _______,       _______,       _______,       _______,       _______, \
