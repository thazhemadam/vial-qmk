...
[_QWERTY] = LAYOUT_vulpes_majora(
  ...
  KC_LSFT, KC_Z,         KC_X,         KC_C,         KC_V,         KC_B,                                                      KC_N,             KC_M,               KC_COMM,          KC_DOT,       KC_SLSH,          KC_RSFT,
                                       KC_ESC,       LT2(KC_BSPACE),  KC_TAB,    KC_MS_BTN3,     KC_MS_BTN1,   KC_MS_BTN2,    KC_ENTER,         LT1(KC_SPACE),       _______,
...
[_RAISE] = LAYOUT_vulpes_majora(
  ...
  KC_HOME, _______, _______, _______, _______, _______,                             KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
